...
class CreateUsersDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users_details', function (Blueprint $table) {
            ...
            $table->tinyInteger('operator')->default(0)->comment("0 - no, 1 - yes");
            ...
            $table->string('operator_license_class')->nullable();
            $table->string('operator_license_state')->nullable()->comment("State/Province/Region");
            $table->string('labor_rate')->nullable()->comment("State/Province/Region");
            $table->timestamps();              
