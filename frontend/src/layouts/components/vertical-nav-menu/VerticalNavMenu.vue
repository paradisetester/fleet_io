    ...
    setVerticalNavMenuWidth() {
      ...
      if(this.windowWidth > 1200) {
        if(this.layoutType === 'vertical') {
          ...
          var addClass = 'content-area-lg';
          if (verticalNavMenuWidth == 'default') {
            addClass = 'content-area-reduced';
          }
          document.getElementById("content-area").className = addClass;
          this.$store.dispatch('updateVerticalNavMenuWidth', verticalNavMenuWidth)

          return
        }
      }
      document.getElementById("content-area").className = 'content-area-full';
      // Close NavMenu
