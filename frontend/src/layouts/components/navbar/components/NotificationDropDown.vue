  ...
  data() {
    return {
      unreadNotifications: [
          {
            index    : 0,
            title    : 'XMASS broadcast emails has been sent',
            msg      : 'click here to see the list of clients included in the broadcast.',
          ...
          { index    : 1,
            ...
            msg      : ' New client "Arun Prasher" has been added.',
            icon     : 'PackageIcon',
