...
<template>
    <vx-card title="Link" code-toggler>
        ...
        <div class="demo-alignment">
            ...
            <vs-button color="success" type="filled" href="https://pixinvent.com/">String literal</vs-button>
            <vs-button color="success" type="filled" :href="{url: 'https://pixinvent.com/'}">Object Path</vs-button>
            <vs-button color="success" type="filled" target href="https://pixinvent.com/">Open New Tab</vs-button>
