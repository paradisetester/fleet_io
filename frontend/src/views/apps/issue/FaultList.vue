  ...
  <div id="vehicle-list" class="data-list-container">
    ...
    <vs-table ref="table" v-model="selected" pagination :max-items="itemsPerPage" search :data="usersData">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="Operator">Assigned</vs-th>
        <vs-th>Action</vs-th>
      </template>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <img src="/img/car1.jpg" width="50px">
                <p class="product-name font-medium truncate">{{ tr.vehicle_name }}</p>
              </vs-td>
        <vs-td>
        <p class="product-name font-medium truncate">{{ tr.issue }}</p>
        </vs-td>
        <vs-td>
        ...
        <p class="product-name font-medium truncate">{{ tr.status }}</p>
              ...
              <vs-td>
                <p class="product-price">{{ tr.Assigned }}</p>
              </vs-td>
...
export default {
  ...
  methods: {
    ...
    {
      var $this = this;
      axios.get(siteIndexURL+'/v1/profile/profiles/')
      .then((result)=>{
  ...
  beforeMount() { 
    ...
    this.usersData = this.definedStrings.vehicle.carFault
  }
}
