  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" v-model="selected" pagination :max-items="itemsPerPage" search :data="usersData">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="category">Insurance Name</vs-th>
        ...
        <vs-th sort-key="category">Premium End Date</vs-th>
        <vs-th sort-key="category">Premium Amount</vs-th>
      </template>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="product-price">{{ tr.premium_end_date }}</p>
              </vs-td>
              <vs-td>
...
export default {
  ...
  methods: {
    ...
    {
      var $this = this;
      axios.get(siteIndexURL+'/v1/tasks/premium_due/')
      .then((result)=>{
