<template>
   <div class="vx-row box_outter">
            ...
            <vs-collapse accordion>
               <vs-collapse-item> 
                  <div class="tab_outter" slot="header">
                     <span class="user_hd">Life Plan (Rider Plan)</span><span class="user_premium">Total Premium Amount : {{sumArray(tabTotalPrice) | PRICEFORMAT}}</span>
                  </div>
      ...
      <vs-popup fullscreen class="holamundo" :title="'Life Plan (Rider Plan)'" :active.sync="popupActive">
         <form v-on:submit.prevent>
            ...
            <div class="vx-row">
               ...
               </div><div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
...
export default {
   ...
   methods: {
      ...
      {
         if (!this.activeyKeyFormData.premium_amount_by_cash) {
            return 0;
         }
         return (this.activeyKeyFormData.mode_of_payment == 'MNT'?((this.activeyKeyFormData.premium_amount_by_cash*12)):(this.activeyKeyFormData.mode_of_payment == 'ANL' || this.activeyKeyFormData.mode_of_payment == 'LPS'?(parseFloat(this.activeyKeyFormData.premium_amount_by_cash)):0));
      },
