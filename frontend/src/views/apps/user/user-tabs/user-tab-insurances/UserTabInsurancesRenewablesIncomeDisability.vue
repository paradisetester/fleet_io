<template>
   <div class="vx-row box_outter">
            ...
            <vs-collapse accordion>
               <vs-collapse-item> 
                  <div class="tab_outter" slot="header">
                     <span class="user_hd">Income Disabilility</span><span class="user_premium">Total Premium Amount : {{sumArray(tabTotalPrice) | PRICEFORMAT}}</span>
                  </div>
      ...
      <vs-popup fullscreen class="holamundo" :title="'Income Disabilility'" :active.sync="popupActive">
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-select
                        ...
                        vs-multiple
                        autocomplete
                        v-model="activeyKeyFormData.claim_criteria"
                        >
                        <vs-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in definedStrings.insurance.claim_criteriaOptions" />
                     </vs-select>
                     <span class="text-danger text-sm" v-show="errors.has('claim_criteria')">{{ errors.first('claim_criteria') }}</span>
                  </div>
               </div>
            </div>
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Disability Benefit"
                        v-model="activeyKeyFormData.disability_benefit"
                        name="disability_benefit"
                        label="Disability Benefit"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('disability_benefit')">{{ errors.first('disability_benefit') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        ...
                        data-vv-as="Payout Duration"
                        v-model="activeyKeyFormData.payout_duration"
                        name="payout_duration"
                        label="Payout Duration"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('payout_duration')">{{ errors.first('payout_duration') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Awl Limit $"
                        v-model="activeyKeyFormData.awl_limit"
                        name="awl_limit"
                        label="Awl Limit $"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('awl_limit')">{{ errors.first('awl_limit') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
