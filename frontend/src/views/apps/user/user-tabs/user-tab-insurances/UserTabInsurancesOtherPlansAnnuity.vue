<template>
   <div class="vx-row box_outter">
            ...
            <vs-collapse accordion>
               <vs-collapse-item> 
                  <div class="tab_outter" slot="header">
                     <span class="user_hd">Annuity</span><span class="user_premium">Total Premium Amount : {{sumArray(tabTotalPrice) | PRICEFORMAT}}</span>
                  </div>
      ...
      <vs-popup fullscreen class="holamundo" :title="'Annuity'" :active.sync="popupActive">
         <form v-on:submit.prevent>
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-select
                        ...
                        name="premium_amount_by_cpf"
                        vs-multiple
                        autocomplete
                        v-model="activeyKeyFormData.premium_amount_by_cpf"
                        >
                        <vs-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in definedStrings.insurance.premium_amount_by_cpfOptions" />
                     </vs-select>
                     <span class="text-danger text-sm" v-show="errors.has('premium_amount_by_cpf')">{{ errors.first('premium_amount_by_cpf') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
            ...
            <div class="vx-row">
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter margin_tp_10">
                     <label>Date When First Payout Start/Drawdown Age (Annual)</label>
                        <datepicker                          
                           class="selectExample w-full"
                           :format="'yyyy-MM-dd'"
                           ...
                           data-vv-as="Date when first payout start"></datepicker>
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-sliders" icon-before icon-no-border
                        data-vv-as="Duration of payout"
                        v-model="activeyKeyFormData.duration_of_payout"
                        name="duration_of_payout"
                        label="Duration of payout"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('duration_of_payout')">{{ errors.first('duration_of_payout') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Estimated retirement payout"
                        v-model="activeyKeyFormData.estimated_retirement_payout"
                        name="estimated_retirement_payout"
                        label="Estimated retirement payout"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('estimated_retirement_payout')">{{ errors.first('estimated_retirement_payout') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Net cash value"
                        v-model="activeyKeyFormData.net_cash_value"
                        name="net_cash_value"
                        label="Net cash value"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('net_cash_value')">{{ errors.first('net_cash_value') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Expected Maturity if Wholelife specify ($)"
                        v-model="activeyKeyFormData.expected_maturity_if_whole_specify"
                        name="expected_maturity_if_whole_specify"
                        label="Expected Maturity if Wholelife specify ($)"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('expected_maturity_if_whole_specify')">{{ errors.first('expected_maturity_if_whole_specify') }}</span>
                  </div>
               </div>
            </div>
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Income Disability($)"
                        v-model="activeyKeyFormData.income_disability"
                        name="income_disability"
                        label="Income Disability($)"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('income_disability')">{{ errors.first('income_disability') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
            ...
            if (result) {
               ...
               if (edit_id == undefined) {
                  ...
                  .then((result) => {
                     ...
                     this.tabsTableDatas.push(response);
