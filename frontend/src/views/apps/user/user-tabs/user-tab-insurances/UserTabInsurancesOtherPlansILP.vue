<template>
   <div class="vx-row box_outter">
            ...
            <vs-collapse accordion>
               <vs-collapse-item> 
                  <div class="tab_outter" slot="header">
                     <span class="user_hd">ILP</span><span class="user_premium">Total Premium Amount : {{sumArray(tabTotalPrice) | PRICEFORMAT}}</span>
                  </div>
      ...
      <vs-popup fullscreen class="holamundo" :title="'ILP'" :active.sync="popupActive">
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Net account value"
                        v-model="activeyKeyFormData.net_account_value"
                        name="net_account_value"
                        label="Net account value"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('net_account_value')">{{ errors.first('net_account_value') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-select
                        ...
                        vs-multiple
                        autocomplete
                        v-model="activeyKeyFormData.dividend_option"
                        >
                        <vs-select-item :key="index" :value="item.value" :text="item.text" v-for="(item,index) in definedStrings.insurance.dividend_optionOptions" />
                     </vs-select>
                     <span class="text-danger text-sm" v-show="errors.has('dividend_option')">{{ errors.first('dividend_option') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-dollar-sign" icon-before icon-no-border
                        data-vv-as="Divided Amount($)"
                        v-model="activeyKeyFormData.dividend_amount"
                        name="dividend_amount"
                        label="Divided Amount($)"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('dividend_amount')">{{ errors.first('dividend_amount') }}</span>
                  </div>
               </div>    
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-sliders" icon-before icon-no-border
                        data-vv-as="Projected account value"
                        v-model="activeyKeyFormData.projected_account_value"
                        name="projected_account_value"
                        label="Projected account value"
                        class="w-full mt-5"/>
                     <span class="text-danger text-sm" v-show="errors.has('projected_account_value')">{{ errors.first('projected_account_value') }}</span>
                  </div>
               </div>
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
