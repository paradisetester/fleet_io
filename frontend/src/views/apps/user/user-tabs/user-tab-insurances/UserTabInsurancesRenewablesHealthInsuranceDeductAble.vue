<template>
   <div class="vx-row box_outter">
            ...
            <vs-collapse accordion>
               <vs-collapse-item> 
                  <div class="tab_outter" slot="header">
                     <span class="user_hd">Health Insurance(Deductable Rider)</span><span class="user_premium">Total Premium Amount : {{sumArray(tabTotalPrice) | PRICEFORMAT}}</span>
                  </div>
      ...
      <vs-popup fullscreen class="holamundo" :title="'Health Insurance(Deductable Rider)'" :active.sync="popupActive">
            ...
            <div class="vx-row">
               ...
               <div class="vx-col sm:w-1/3 w-full" >
                  <div class="vx-row box_outter">
                     <vs-input
                        v-validate="'required'"
                        icon-pack="feather" icon="icon-hash" icon-before icon-no-border
